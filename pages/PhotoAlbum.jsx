...
import NavSelf from '../components/NavMent/NavMyself';
...
const PhotoAlbum = () => {
  ...
  const [faqs, setFaqs] = useState([
    {
      ...
      answer: `Products.....Non-Fungible Tokens are unique, easily verifiable digital assets that
  ...
  return (
    <div className="faqWrapper">
      <h1 className="faqTitle">Software Products</h1>
      ...
      <br />
      <h1>Photo Album Section</h1>
      <br />
      <h2> PHotography Software </h2>
      <br />
